...
export default async function AIHealthcareBlogsPage() {
  const blogs = await getAIHealthcareBlogs();
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">
            AI in <span className="gradient-text">Healthcare</span>
          </h1>
        </div>
        <p className="text-lg text-slate-200 max-w-3xl">
          Exploring machine learning applications in clinical and population health settings, 
          from diagnosis to treatment optimization to health equity.
        </p>
      </section>
