...
export default async function ResponsibleAIBlogsPage() {
  const blogs = await getResponsibleAIBlogs();
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12">
        ...
        <p className="text-lg text-slate-200 max-w-3xl">
          Essays on ethics, fairness, safety, and accountability in AI systems, 
          with a focus on healthcare applications and vulnerable populations.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-20">
        {blogs.length > 0 ? (
          ...
          <div className="text-center py-12 border border-white/10 rounded-lg">
            <p className="text-slate-400 mb-4">No posts yet in this category.</p>
            <p className="text-sm text-slate-500">Check back soon for essays on AI ethics, fairness, and safety in healthcare.</p>
          </div>
        )}
      </section>
    </main>
