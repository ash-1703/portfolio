...
export default async function DesignUXBlogsPage() {
  const blogs = await getDesignUXBlogs();
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">
            Design & <span className="gradient-text">User Experience</span>
          </h1>
        </div>
        <p className="text-lg text-slate-200 max-w-3xl">
          Empathetic, usable, and trustworthy AI tools for patients and clinicians. 
          Exploring HCI methods, explainability, accessibility, and human-centered design in healthcare.
        </p>
      </section>
