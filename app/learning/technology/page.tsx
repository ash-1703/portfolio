...
export default async function TechnologyLearningPage() {
  const learningEntries = await getTechnologyEntries();
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-4xl px-4 pb-20">
        ...
        {/* <div className="mt-12 text-center text-slate-400 text-sm">
          <p>💡 Add new entries by creating a new page in <code className="bg-white/5 px-2 py-1 rounded">app/learning/technology/[slug]</code></p>
        </div> */}
      </section>
    </main>
  );
