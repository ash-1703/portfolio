      ...
      <section className="mx-auto max-w-4xl px-4 pt-24 pb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">
            Public Health & <span className="gradient-text">Medicine</span>
          </h1>
        </div>
        <p className="text-lg text-slate-200 max-w-3xl">
          Daily learning log tracking insights in social determinants, epidemiology, 
          healthcare systems, and population health strategies.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-20">
        <div className="space-y-6">
          {learningEntries.map((entry, idx) => (
            <Link
              key={idx}
              href={`/learning/public-health/${entry.slug}`}
