...
export default async function CertificationsPage() {
  ...
  const publicHealthCerts = allCertifications.filter(
    (cert: any) => cert.category === 'human-centered-ai-healthcare' && cert.status === 'completed'
  );
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-4xl px-4 pt-24 pb-12">
        ...
        <p className="text-lg text-slate-200 max-w-3xl">
          ...
          expertise in public health, medicine, AI, and responsible technology.
        </p>
      </section>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div className="flex-1">
                  ...
                  <blockquote className="border-l-2 border-cyan-500/30 pl-4 text-slate-200 text-sm italic">
                    {cert.takeaway}
                  </blockquote>
                </div>
                {cert.certificateUrl && (
