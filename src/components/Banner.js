...
const Banner = () => {
  ...
  <div className='container mx-auto'>
    ...
    <div className='flex-1 text-center font-secondary lg:text-left'>
      <motion.h1 variants={fadeIn('up',0.4)} initial="hidden" whileInView={'show'} viewport={{once: false, amount:0.7}} className='text-[55px] font-bold leading-[0.8] lg:text-[90px]'>
      ...
      className='mb-8 max-w-lg mx-auto lg:mx-0'>An ambitious new graduate in software development, seamlessly translating ideas into executable brilliance, prepared to reshape the digital world with innovative solutions and unwavering determination</motion.p>
      <motion.div variants={fadeIn('down',0.6)} initial="hidden" whileInView={'show'} viewport={{once: false, amount:0.7}}
      ...
      className='flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-0'>
        <a href='https://www.linkedin.com/in/aishwarya-tupe/' target="_blank">
          <FaLinkedinIn/>
        </a>
